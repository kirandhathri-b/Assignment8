...
// Disable clicks on all calculator buttons 
$("#calculator-buttons .calcButton").click(function(event) {
  event.preventDefault();
});

// Attach click event listeners to the "nav-next" and "nav-select" buttons
